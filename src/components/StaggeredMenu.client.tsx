...
const StaggeredMenuClient: React.FC<StaggeredMenuProps> = ({
  position = 'right',
    ...
    >
      ...
      >
        ...
        >
          <div
            className={cn(
              'pointer-events-auto mx-auto w-11/12 md:w-3/4 h-16 px-4 flex items-center justify-between transition-all',
              !open &&
                'rounded-2xl border border-primary/30 bg-primary/35 bg-gradient-to-r from-primary/25 via-card/15 to-primary/25 backdrop-blur-md shadow-xl'
            )}
          >
