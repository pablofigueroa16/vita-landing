...
const solution = () => {
  return (
    <div
      id="solution"
      className="relative min-h-[85vh] md:min-h-screen w-full z-10 flex flex-col items-center justify-center gap-5 md:gap-8 px-4 sm:px-6 text-center pt-16 md:pt-24 pb-12"
    >
      <ScrollFloat
        animationDuration={1}
        ease="back.inOut(2)"
        ...
        textClassName="text-brand font-semibold text-xs sm:text-sm md:text-base"
      >
        La Solución
      </ScrollFloat>
      <h2 className="text-text font-bold text-2xl sm:text-3xl md:text-5xl leading-tight">
        Una experiencia de comercio sin fricción, más rápida y más humana.
      </h2>
      <p className="text-text-secondary mx-2 sm:mx-[10%] font-semibold text-sm sm:text-base md:text-lg leading-relaxed md:leading-normal mb-2 md:mb-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5 w-full">
        <SpotlightCard
          className="custom-spotlight-card col-span-1 sm:col-span-2"
          spotlightColor="hsl(200 100% 45%)"
        >
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 justify-center p-4 md:p-6 text-left">
            <div className="flex-1 flex flex-col gap-3 md:gap-4 items-start justify-center">
              <div className="flex flex-row items-center gap-2">
                <Image
                  ...
                  priority={false}
                />
                <h2 className="mx-2 text-text font-bold text-lg sm:text-xl md:text-2xl leading-tight">
            ...
            <div className="flex-1 flex items-center justify-center">
              <Image
                ...
                width={360}
                height={760}
                className="w-full max-w-[220px] sm:max-w-[260px] md:max-w-2xs"
                priority={false}
                unoptimized={true}
              />
            </div>
        ...
        <SpotlightCard
          ...
          spotlightColor="hsl(200 100% 45%)"
        >
          <div className="flex flex-col gap-4 p-4 md:p-4 text-left w-full min-h-[320px]">
            <div className="flex-1 flex flex-col py-6 md:py-10 gap-4 items-start justify-center">
              <div className="flex flex-row items-center gap-2">
                <Image
                  src="/solution/2.png"
                  ...
                  priority={false}
                />
                <h2 className="mx-2 text-text font-bold text-lg sm:text-xl md:text-xl leading-tight">
            ...
            <div className="flex-1 flex items-center justify-center p-2 sm:p-4 md:p-6">
              <div
                className="relative w-full max-w-[220px] sm:max-w-[250px] md:max-w-[290px] aspect-square"
                style={{ "--orbit-radius": "clamp(72px, 12vw, 144px)" } as CSSProperties}
              >
                ...
                >
                  {orbitIcons.map((icon) => (
                    <div
                      key={icon.angle}
                      className="absolute top-1/2 left-1/2 w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center -translate-x-1/2 -translate-y-1/2"
                      style={{
